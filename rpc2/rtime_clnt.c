...
/* client makes a remote procedure call to get the time on the server machine */
...
/* This routine tries to establish a connection to the server running on machine machine_name */
RPC2_Handle connect_to_machine(machine_name)
char *machine_name;
{
  RPC2_HostIdent hid;
